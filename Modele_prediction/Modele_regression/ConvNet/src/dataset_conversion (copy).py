...
if __name__=="__main__":
    ...
    categories = [
    "elbow_extension", "elbow_flexion","rest_low_arm","rest_post_abduction","rest_post_elbow_flexion","rest_post_shoulder_flexion",
    "shoulder_abduction", "shoulder_adduction", "shoulder_extension", "shoulder_flexion"]

    for category in categories:
        print(category)
        data = np.load(filepath + "/" + category + "_3s_2000Hz.npy")
        #print(data)
        print(data.shape)
        print("c'est pas  le jesus")
